...
* Which-key is activated by default. Upon pushing any key, (including some modifier keys), it will show what they are bound to. Hitting backspace will go back to the root view.
